...
import { ILocationResponseModel } from '../interfaces/location-response.model';
...
export class LocationService {
  ...
  locations(): Observable<ILocationResponseModel[]> {
    return this.http.get<ILocationResponseModel[]>(`${this.URL}/All`);
  }

  locationsById(id: number | null): Observable<ILocationResponseModel> {
